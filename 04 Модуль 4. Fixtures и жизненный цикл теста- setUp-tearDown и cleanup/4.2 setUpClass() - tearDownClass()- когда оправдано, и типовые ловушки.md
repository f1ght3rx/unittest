...
class TestWithClassFixture(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.fixture_file.write_text(json.dumps({"vat": 20, "discount": 10}), encoding="utf-8")
...
class TestPatchingOnce(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.addClassCleanup(cls._patcher.stop)   # гарантирует stop даже при сбое setUpClass
